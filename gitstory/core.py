"""GITSTORY core — Changelog and release notes from conventional commits."""
...
RULES = [
    ("GIT-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("GIT-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("GIT-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
