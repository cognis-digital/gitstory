#!/usr/bin/env sh
# Universal installer for gitstory. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/gitstory.git"
echo "Installing gitstory ..."
