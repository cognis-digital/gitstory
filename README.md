...
[![PyPI](https://img.shields.io/pypi/v/cognis-gitstory.svg)](https://pypi.org/project/cognis-gitstory/)
[![CI](https://github.com/cognis-digital/gitstory/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/gitstory/actions)
...
GITSTORY exists for one job — changelog and release notes from conventional commits — and does it without a SaaS bill or heavyweight setup.
...
```bash
gitstory --version
gitstory scan .                      # scan the current project
gitstory scan . --format json
gitstory scan . --fail-on high       # non-zero exit for CI gates
gitstory mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **git-cliff**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`gitstory` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
